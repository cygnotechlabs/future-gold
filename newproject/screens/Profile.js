...
const Profile = () => {
  ...
  const [state] = useContext(AuthContext); // Get state directly

   // Check if the user data is available
   const userName = state.user?.name || "Guest"; // Fallback to "Guest" if name is not defined
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        <TouchableOpacity style={styles.routingContainer} onPress={() => navigation.navigate('ContactUs')}>
        ...
        <TouchableOpacity style={styles.routingContainer} onPress={() => navigation.navigate('AboutUs')}>
